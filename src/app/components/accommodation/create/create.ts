...
import { AccommodationI } from '../../../models/accommodation';
...
export class Create implements OnInit, OnDestroy {
  ...
  onSubmit(): void {
    if (this.accommodationForm.valid) {
      this.loading = true;
      const accommodationData: AccommodationI = this.accommodationForm.value;
        ...
        this.accommodationService.createaccommodation(accommodationData).subscribe({
          next: (response) => {
            this.messageService.add({
              severity: 'success',
              summary: 'Éxito',
              detail: 'Alojamiento creado correctamente'
            });
            setTimeout(() => {
          ...
          error: (error) => {
            ...
            this.messageService.add({
              severity: 'error',
              summary: 'Error',
              detail: 'No se pudo crear el alojamiento'
            });
          }
        })
      );
